magicapp MATLAB Python Package
...
2. Installing the magicapp Package

A. Change to the directory that contains the file setup.py and the subdirectory magicapp. 
...
3. Using the magicapp Package

The magicapp package is on your Python path. To import it into a Python script or 
session, execute:
